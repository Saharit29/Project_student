        ...
        <form action="Insert.php" method="POST" class="row g-3">
            ...
            <div class="row g-3">
                <div class="col-md-2">
                    ...
                    <input type="text" name="trainee_name" class="form-control" id="trainee_name" readonly>
                </div>
                <div class="col-md-2">
                    <label for="trainee_lname" class="form-label">สกุล</label>
                    <input type="text" name="trainee_lname" class="form-control" id="trainee_lname" readonly>
                </div>
                <div class="col-md-2">
                    <label for="jobtitle" class="form-label">ตำแหน่ง</label>
                    <input type="text" name="jobtitle" class="form-control" id="jobtitle" readonly>
                </div>
            ...
            <div class="col-md-2">
                ...
                <input type="text" id="housenumber" name="housenumber" class="form-control" readonly>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                ...
                <input type="text" id="subdistrict" name="subdistrict" class="form-control" readonly>
            </div>
            <div class="col-md-2">
